...
const app = express();
const PORT = 3000;
const BOT_TOKEN = '7037175536:AAHJ4h8gb9kZyAXsWniUFEAFvHX0cooQAxE';
const OWNER_ID = 6200725887;
...
if (!fs.existsSync(userDBFile)) fs.writeFileSync(userDBFile, JSON.stringify([{ username: "naell", password: "riyah" }]));
